    ...
    <nav class="bg-gray-800 pt-2 md:pt-1 pb-1 px-1 mt-0 h-auto fixed w-full z-20 top-0">
        ...
        <div class="flex flex-wrap items-center">
            <div class="flex flex-shrink md:w-1/3 justify-center md:justify-start text-white">
                <a class="text-3xl md:text-4xl md:mt-2 flex font-bold md:pl-9" href="#">
                    Admin
                </a>
            </div>
            
            {{-- Search --}}
            <div class="block md:hidden flex flex-1 md:w-1/3 justify-center pt-1 md:justify-start text-white px-2">
            ...
            <div class="flex w-full md:pt-4 content-center md:w-4/6 justify-end md:justify-end">
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            ...
                            <div id="myDropdown" class="dropdownlist absolute bg-gray-800 text-white md:right-0 mt-3 p-3 overflow-auto z-30 invisible">
